...
The repository includes a runnable project under [`example/`](https://github.com/rutviknabhoya/react-native-alternate-app-icon/tree/main/example) with iOS and Android assets preconfigured.
