...
See the [complete example](/docs/guides/full-example) or the [example app](https://github.com/rutviknabhoya/react-native-alternate-app-icon/tree/main/example) in the repository.
